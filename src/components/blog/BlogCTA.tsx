...
export const BlogCTA: React.FC = () => {
  ...
  const { facebook, instagram, linkedin, youtube } = useContactInfo();
          ...
          <div className="blog-cta-right">
            <div className="blog-social-block">
              ...
              <div className="blog-social-links">
                <a href={instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="blog-social-icon">
                ...
                <a href={facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="blog-social-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                  </svg>
                </a>
                <a href={linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="blog-social-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <a href={youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="blog-social-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
